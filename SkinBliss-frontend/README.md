# SkinBliss - Beauty & Cosmetics – Full Stack eCommerce Web Application + Admin Panel

![SkinBliss Image Banner](https://i.ibb.co/yBHL1wj/beauty-cosmetics.png)

SkinBliss Beauty & Cosmetics is a powerful and modern full stack eCommerce web application built using Next.js, Express.js, MongoDB with Mongoose, Redux Toolkit, RTK Query, Stripe payment method, Bootstrap 5, and Sass. It includes a feature-rich admin panel for easy management and control of your online store.
...
- **Authentication:** SkinBliss includes features for Google login, user registration, email verification, forgot password, reset password, and profile updates.
...
- **Typescript + Next.js App Directory:** SkinBliss leverages TypeScript in combination with Next.js, enhancing code reliability and maintainability.
...
- **Responsive Layout Design:** SkinBliss is fully responsive across all devices, providing a seamless experience for your customers.
...
- **Flexible and Multi-Purpose:** SkinBliss is versatile and can be adapted to various eCommerce niches.
...
- **All E-commerce Features and Apps Included:** SkinBliss provides a comprehensive eCommerce solution with all the essential features and apps needed for a successful online store.
...
To get started with SkinBliss, follow these steps:
...
[SkinBliss Client Side Live Link](https://shofy-beauty-cosmetics-ecommerce.vercel.app)

## Server Side Live Link

[SkinBliss Server Side Live Link](https://shofy-backend.vercel.app)

## Client Side Repo

[SkinBliss Client Side Repo](https://github.com/Hamed-Hasan/shofy-Beauty-and-Cosmetics-ecommerce-client.git)

## Server Side Repo

[SkinBliss Server Side Repo](https://github.com/Hamed-Hasan/shofy-Beauty-and-Cosmetics-ecommerce-backend.git)
...
## Thank You for Choosing SkinBliss!

We hope you find SkinBliss to be a powerful and effective solution for your eCommerce needs. Should you encounter

any issues or have any questions, please feel free to reach out to our support team at vedrafabiola@gmail.com. Happy selling!
