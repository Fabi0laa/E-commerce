...
// internal
import { useGetRelatedProductsQuery, useGetSuggestedProductsQuery } from '@/redux/features/productApi';
...
const RelatedProducts = ({ id }) => {
  const { data: products, isError, isLoading } = useGetSuggestedProductsQuery(id);
