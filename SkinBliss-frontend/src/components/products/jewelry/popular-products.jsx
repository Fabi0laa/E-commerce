...
const PopularProducts = () => {
  const { data: products, isError, isLoading } = useGetSuggestedProductsQuery({ type: 'jewelry', query: `new=true` });
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-section-title-wrapper-4 mb-60 text-center">
                ...
                <h3 className="tp-section-title-4">Popular on the SkinBliss store.</h3>
              </div>
            </div>
          </div>
          <div className="row">
