    ...
    content = (
      <Swiper {...slider_setting} modules={[Scrollbar]} className="tp-category-slider-active-2 swiper-container mb-50">
        {product_items.map((item) => (
          <SwiperSlide key={item.id} className="tp-category-item-2 p-relative z-index-1 text-center">
            ...
            <div className="tp-category-content-2">
              ...
              <div className="tp-category-btn-2">
                {cart_products.some((prd) => prd.id === item.id) ? (
                  <Link href="/cart" className="tp-btn tp-btn-border cursor-pointer">
                    View Cart
                  </Link>
                ) : (
                  <a onClick={() => handleAddProduct(item)} className="tp-btn tp-btn-border cursor-pointer">
                    Add to Cart
                  </a>
                )}
              </div>
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-section-title-wrapper-2 text-center mb-50">
                ...
                <h3 className="tp-section-title-2">Popular on the SkinBliss store.</h3>
              </div>
            </div>
          </div>
          <div className="row">
